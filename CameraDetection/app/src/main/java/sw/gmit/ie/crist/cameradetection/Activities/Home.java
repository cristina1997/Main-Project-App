...
import sw.gmit.ie.crist.cameradetection.Models.CurrentUser;
...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, NameDialog.NameDialogListener {
    ...
    private void notifications() {
        String userName = splitAndJoin (currentUser.getUserName());
    ...
    private void setNavHeader() {
        ...
        txtProfileName.setText (currentUser.getUserName());
    }
...
//                callIntent.setData(Uri.parse("tel:(+353)866623216"));
//                if (ActivityCompat.checkSelfPermission
//                    (Home.this, Manifest.permission.CALL_PHONE) !=
    ...
    private void downloadVideo() {
        ...
        if (videos.size () != 0) {
            for (int i = 0; i < videos.size (); i++) {
                ref = storage.child ("images/" + currentUser.getUserName() + "/" + videoPerson + "/" + videos.get (i));
